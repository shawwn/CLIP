class MultiheadAttention(Module):
  ...
  def forward(self: __torch__.torch.nn.modules.activation.___torch_mangle_9414.MultiheadAttention,
  ...
  def forward1(self: __torch__.torch.nn.modules.activation.___torch_mangle_9414.MultiheadAttention,
    argument_1: Tensor) -> Tensor:
