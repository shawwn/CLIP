class MultiheadAttention(Module):
  ...
  in_proj_bias : Tensor
  training : bool
  out_proj : __torch__.torch.nn.modules.linear.___torch_mangle_9404._LinearWithBias
  def forward(self: __torch__.torch.nn.modules.activation.___torch_mangle_9405.MultiheadAttention,
  ...
  def forward1(self: __torch__.torch.nn.modules.activation.___torch_mangle_9405.MultiheadAttention,
    argument_1: Tensor) -> Tensor:
