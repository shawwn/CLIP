class MultiheadAttention(Module):
  ...
  in_proj_bias : Tensor
  training : bool
  out_proj : __torch__.torch.nn.modules.linear.___torch_mangle_9524._LinearWithBias
  def forward(self: __torch__.torch.nn.modules.activation.___torch_mangle_9525.MultiheadAttention,
    argument_1: Tensor,
  ...
  def forward1(self: __torch__.torch.nn.modules.activation.___torch_mangle_9525.MultiheadAttention,
    argument_1: Tensor,
    attn_mask: Tensor) -> Tensor:
