class LayerNorm(Module):
  ...
  bias : Tensor
  training : bool
  def forward(self: __torch__.multimodal.model.multimodal_transformer.___torch_mangle_9526.LayerNorm,
    ...
    return query
  def forward1(self: __torch__.multimodal.model.multimodal_transformer.___torch_mangle_9526.LayerNorm,
    argument_1: Tensor) -> Tensor:
    _2 = self.bias
    _3 = self.weight
    input = torch.to(argument_1, torch.device("cuda:0"), 6, False, False, None)
