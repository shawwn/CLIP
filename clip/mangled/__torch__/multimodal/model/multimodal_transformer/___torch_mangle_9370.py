class LayerNorm(Module):
  ...
  bias : Tensor
  training : bool
  def forward(self: __torch__.multimodal.model.multimodal_transformer.___torch_mangle_9370.LayerNorm,
    x: Tensor) -> Tensor:
    _0 = self.bias
    _1 = self.weight
    ...
    return query
  def forward1(self: __torch__.multimodal.model.multimodal_transformer.___torch_mangle_9370.LayerNorm,
    x: Tensor) -> Tensor:
    _2 = self.bias
    _3 = self.weight
    input = torch.to(x, torch.device("cuda:0"), 6, False, False, None)
