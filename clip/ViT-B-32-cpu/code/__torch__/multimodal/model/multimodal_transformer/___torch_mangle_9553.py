class LayerNorm(Module):
  ...
  bias : Tensor
  training : bool
  def forward(self: __torch__.multimodal.model.multimodal_transformer.___torch_mangle_9553.LayerNorm,
    ...
    return query
  def forward1(self: __torch__.multimodal.model.multimodal_transformer.___torch_mangle_9553.LayerNorm,
    argument_1: Tensor) -> Tensor:
    _2 = self.bias
    _3 = self.weight
    input = torch.to(argument_1, torch.device("cpu"), 6, False, False, None)
