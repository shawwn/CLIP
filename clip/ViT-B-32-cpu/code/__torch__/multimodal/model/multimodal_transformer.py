class VisualTransformer(Module):
  ...
  def forward(self: __torch__.multimodal.model.multimodal_transformer.VisualTransformer,
    ...
    _14 = torch.zeros([_12, 1, int(_13)], dtype=5, layout=None, device=torch.device("cpu"), pin_memory=False)
    ...
    _16 = torch.matmul((_1).forward(x5, ).float(), _0.float())
    return _16
  def forward1(self: __torch__.multimodal.model.multimodal_transformer.VisualTransformer,
    ...
    _31 = torch.zeros([_29, 1, int(_30)], dtype=5, layout=None, device=torch.device("cpu"), pin_memory=False)
